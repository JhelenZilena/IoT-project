...
class SensorController extends Controller
{
    ...
    {
        $Departaments = Departaments::with('country')
            ->orderBy('name')
            ->get();
        
        return view('sensors.create', compact('Departaments'));
    }
    ...
    public function store(Request $request)
{
    ...
    Sensor::create([
        ...
        'id_departament' => $data['id_Departaments'], // ← CORREGIDO: sin 's'
    ...
    public function edit(Sensor $sensor)
    {
        ...
        return view('sensors.edit', compact('sensor', 'Departaments'));
    }
